...
class CouplingPolicy:
    ...
    reaction_rate_basis: str = "volumetric_mass"
    ...
    def __post_init__(self) -> None:
        ...
        if self.reaction_rate_basis not in {"volumetric_mass", "specific"}:
            raise ValueError(
                "reaction_rate_basis must be 'volumetric_mass' or 'specific'"
            )
    ...
    def to_plan(self) -> dict[str, object]:
        return {
            ...
            "reaction_rate_basis": self.reaction_rate_basis,
