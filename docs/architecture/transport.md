...
explicitly excluded. A central combustion run across an existing interactive
host allocation and a one-node client allocation remains a higher-level
integration gate rather than a Fjord transport gate.
